  ...
  return (
    <MainLayout>
      <RichText>
        ...
        information, at anytime, by contacting us at infoleblancstudios@gmail.com or
        mailing us at:
        <br />
        LEBLANCSTUDIOS
        <br />
        JOSE BREA PEÑA #66 Santo Domingo DO 10147
        <br />
        <br />
        ...
        SECTION 7 - COOKIES
        <br />
        <br /> Here is a list of cookies that we use. We’ve listed them here so you
        that you can choose if you want to opt-out of cookies or not.
        <br /> _session_id, unique token, sessional, Allows Shopify to store
        information about your session (referrer, landing page, etc).
        <br /> _shopify_visit, no data held, Persistent for 30 minutes from the last
        visit, Used by our website provider’s internal stats tracker to record the
        number of visits
        <br /> _shopify_uniq, no data held, expires midnight (relative to the
        ...
        <br /> _secure_session_id, unique token, sessional
        <br /> storefront_digest, unique token, indefinite If the shop has a
        ...
        <br />
        <br /> By using this site, you represent that you are at least the age of
        ...
        infoleblancstudios@gmail.com or by mail at
        <br />
        LEBLANCSTUDIOS
        <br />
